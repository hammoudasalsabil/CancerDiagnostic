...
const doctorRoute : Routes = [
  {
    ...
    children:[
      ...
      {path:'patientsEdit',component:PatientseditComponent},
      {path:'patientsView',component:PatientviewComponent},
      {path:'patientsAdd',component:PatientaddComponent},
      {path:'diagnosticSienOne',component:DiagnosticseinoneComponent},
